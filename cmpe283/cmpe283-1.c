...
struct capability_info primary_proc_based_control[21] = 
{
	...
	{ 11, "RDPMC exiting" },
	{ 12, "RDTSC exiting" },
	{ 15, "CR-3-load exiting" },
	{ 16, "CR-3-store exiting" },
	{ 19, "CR8-load exiting" },
...
detect_vmx_features(void)
{
	...
	pr_info("Primary Proc Based Controls MSR: 0x%llx\n",
		(uint64_t)(lo | (uint64_t)hi << 32));
	report_capability(primary_proc_based_control, 21, lo, hi);
